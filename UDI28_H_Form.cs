...
namespace Project_Product_List
{
    ...
    public partial class UDI28_H_Form : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM [Udi28_dt] where Seriel_Code LIKE '%" + productSerialNumber + "';", sqlCon);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM [Udi28_dt] where Customer_Name = '" + CustomerName + "';", sqlCon);
                DataTable dtbl = new DataTable();
                sqlDa.Fill(dtbl);
                dataGridView1.DataSource = dtbl;
            }
        ...
        public void Delete_from_udi28()
        {
            ...
            cmd.CommandText = "DELETE FROM Udi28_dt WHERE Seriel_Code = '" + deleteSN + "';";
        ...
        private void UDI28_H_Form_Load(object sender, EventArgs e)
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM [Udi28_dt] ; ", sqlCon);
                DataTable dtbl = new DataTable();
                sqlDa.Fill(dtbl);
                dataGridView1.DataSource = dtbl;
            }
        ...
        public void createExcelFile()
        {
            ...
            saveFileDialog1.FileName = "UDI28 TESTS HISTORY";
