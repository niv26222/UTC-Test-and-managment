...
{
    public partial class Udi18InspectionForm : Form
    {

        string connectionString = Paths.Paths.UTC_SQL_CONNECTION_NEW;
        string SavePath = Paths.Paths.UDI_28_PATH;
        //string SavePath = "T:\\Users\\NivBE\\source\\repos";


        public Udi18InspectionForm()
        {
            InitializeComponent();
        }
        ...
        private void Udi18InspectionForm_Load(object sender, EventArgs e)
        {
            textBoxPressureSensor.Text = "100 PSI";
        ...
        public void InsertToDataBase()
        {
            ...
            try
            {
                ...
                {
                    cnn.Execute("insert into UDI28 (Number, Seriel_Code, Screen, Antena, Plastic, Screw, Button_function, Cover, Message_to_all_users, Message_between_2_udi_28_wrist, SOS_message, Compass, PC_Connection, Load_Messages, Load_Names, Update_udi_ver, Date_Time, Charging, Quick_connector, USBcable, Power_Supply, Case_, Date, Tested_by, Signature, Customer_Name, Pressure_sensor, WaybillNumber, Table_Tag, Serial_Correct) values ('" + Number + "','" + textBoxUdiSerielNumber.Text.Trim() + "', '" + Convert.ToInt32(checkBoxScreenOK.Checked)  + "', '" + Convert.ToInt32(checkBoxAntenaOK.Checked) + "' , '" + Convert.ToInt32(checkBoxPlasticOK.Checked) + "', '" + Convert.ToInt32(checkBoxScrewOK.Checked) + "', '" + Convert.ToInt32(checkBoxButtonFunctionOK.Checked) + "','" + Convert.ToInt32(checkBoxCoverOK.Checked) + "' , '" + Convert.ToInt32(checkBoxMessageToAllUsersOK.Checked) + "', '" + Convert.ToInt32(checkBoxMessageBetween2UDI28WristOK.Checked) + "', '" + Convert.ToInt32(checkBoxSOSMessageOK.Checked) + "', '" + Convert.ToInt32(checkBoxCompassOK.Checked) + "', '" + Convert.ToInt32(checkBoxPCConnectionToDiveSimOK.Checked) + "', '" + Convert.ToInt32(checkBoxLoadMessageOK.Checked) + "', '" + Convert.ToInt32(checkBoxLoadNamesOK.Checked)  + "', '" + textBoxUdiVer.Text.Trim() + "', '" + Convert.ToInt32(checkBoxDateTimeOK.Checked) + "', '" + Convert.ToInt32(checkBoxChargingLightOK.Checked) + "',  '" + Convert.ToInt32(checkBoxQuickConnectorOK.Checked) + "', '" + Convert.ToInt32(checkBoxUSBCableOK.Checked) + "', '" + Convert.ToInt32(checkBoxPowerSupplyOK.Checked) + "', '" + Convert.ToInt32(checkBoxCaseOK.Checked) + "', '" + dateTimePicker1.Text.Trim() + "', '" + textBoxTestedBy.Text.Trim() + "', '" + textBoxSignature.Text.Trim() + "', '" + comboBox1.Text.Trim() + "', '" + textBoxPressureSensor.Text.Trim() + "', '" + textBoxWaybillNumber.Text.Trim() + "', '" + comboBoxTableTag.Text.Trim() + "', '" + checkBoxUdiSerialCorrectOK.Checked + "')");
                }
        ...
        private void SendToPrinter_udi28()
        {
        ...
        void PDFCreator()
        {
            ...
            Chunk productName = new Chunk("UDI-28 Inspection.", FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 18, BaseColor.BLUE));
            ...
            bool MB2UW = (checkBoxMessageBetween2UDI28WristOK.Checked);
            bool NOT_CHECKED_MB2UW = (!checkBoxMessageBetween2UDI28WristOK.Checked) && (!checkBoxMessageBetween2UDI28WristFAIL.Checked);
            ...
            //bool Cover = (checkBoxCoverOK.Checked);
            //bool NOT_CHECKED_Cover = (!checkBoxCoverOK.Checked) && (!checkBoxCoverFAIL.Checked);
        ...
        public void Update_WayBill()
        {
            ...
            cmd.CommandText = "UPDATE  Udi28_dt SET WaybillNumber= '" + WaybillNumber + "' WHERE Seriel_Code = '" + SerielNumber + "';";
