...
namespace Project_Product_List
{
    public partial class Udi18InspectionForm : Form
    {
        ...
        private void Udi18InspectionForm_Load(object sender, EventArgs e)
        {
            ...
            string SavePath = "U:" + @"\" + "Acceptance Testing" + @"\" + DOCyear + @"\" + "UDI-28" + @"\";
        ...
        public void InsertIntoData()
        {
            ...
            try
            {
                ...
                {
                    sqlCon.Open();
                    SqlCommand sqlCmd = new SqlCommand("Udi28_add", sqlCon);
                    ...
                    sqlCmd.Parameters.AddWithValue("@Message_between_2_udi_28_wrist", checkBoxMessageBetween2UDI28WristOK.Checked);
                    ...
                    sqlCmd.Parameters.AddWithValue("@Update_udi_ver", textBoxUdiVer.Text.Trim());
                    ...
                    sqlCmd.Parameters.AddWithValue("@Pressure_sensor", textBoxPressureSensor.Text.Trim());
        ...
        private void SendToPrinter_udi28()
        {
            ...
            info.FileName = "U:" + @"\" + "Acceptance Testing" + @"\" + DOCyear + @"\" + "UDI-28" + @"\" + textBoxUdiSerielNumber.Text + "_AT" + PDFcounter + ".pdf";
        ...
        void CreateInspectionTestDocument()
        {
            ...
            SavePath = "U:" + @"\" + "Acceptance Testing" + @"\" + DOCyear + @"\" + "UDI-28" + @"\" + textBoxUdiSerielNumber.Text + "_AT" + PDFcounter + ".pdf";
